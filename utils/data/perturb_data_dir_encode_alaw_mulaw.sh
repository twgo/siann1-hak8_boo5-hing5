...
if [ $# != 2 ]; then
  ...
  echo "Applies standard 3-way speed perturbation using factors of 1.1, 1.0 and 1.1."
  echo "e.g.:"
...
# utils/data/perturb_data_dir_encode.sh 0.9 ${srcdir} ${destdir}_speed1.1 || exit 1
